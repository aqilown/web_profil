...
<?php include("includes/header.php") ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info">
      ...
      action="konfirmasieditjenjang.php?data=<?php echo $id_master_jenjang; ?>">
        <div class="card-body">
          <div class="form-group row">
            <label for="jenjang" class="col-sm-3 col-form-label">Tag</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" id="jenjang" name="jenjang" value="<?php echo $jenjang; ?>" placeholder="Masukkan Tag" required>
            </div>
          </div>
        </div>
        <!-- /.card-body -->
