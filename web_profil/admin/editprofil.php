...
if (isset($_SESSION['id_user'])) {
  ...
  $sql_d = "select `nama`, `email`,`deskripsi` from `user` where `id_user` = '$id_user'";
  ...
  //get soft skill
  $sql_ss = "SELECT `id_master_soft_skill` FROM `soft_skill` where `id_user`='$id_user'";
  ...
  //get hard skill
  $sql_hs = "SELECT `id_master_hard_skill` FROM `hard_skill` where `id_user`='$id_user'";
          ...
          <form class="form-horizontal" method="post" action="konfirmasieditprofil.php" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  <?php
                  $sql_s = "SELECT `id_master_soft_skill`,`soft_skill` FROM `master_soft_skill` 
                  ...
                  while ($data_s = mysqli_fetch_row($query_s)) {
                    ...
                    $ss = $data_s[1];
                    ?>
                    <input type="checkbox" name="soft_skill[]" value="<?php echo $id_ss; ?>" 
                    <?php if (in_array($id_ss, $array_ss)) { ?>checked="checked" <?php } ?>> <?php echo $ss; ?></br>
                  <?php } ?>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <label for="hardskill" class="col-sm-3 col-form-label">

                  Hard Skill</label>
                <div class="col-sm-7">
                  <?php
                  $sql_h = "SELECT `id_master_hard_skill`,`hard_skill` FROM `master_hard_skill`
                  ...
                  while ($data_h = mysqli_fetch_row($query_h)) {
                    ...
                    $hs = $data_h[1];
                    ?>
                    <input type="checkbox" name="hard_skill[]" value="<?php echo $id_hs; ?>" 
                    <?php if (in_array($id_hs, $array_hs)) { ?>checked="checked" <?php } ?>> <?php echo $hs; ?></br>
                  <?php } ?>
                </div>
              </div>
