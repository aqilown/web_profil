...
if (isset($_SESSION['id_user'])) {
    ...
    if (empty($nama)) {
        ...
        if (move_uploaded_file($lokasi_file, $direktori)) {
            ...
            `foto`='$nama_file',`deskripsi`='$deskripsi'where `id_user`='$id_user'";
            //echo $sql;
            mysqli_query($koneksi, $sql);
        } else {

            $sql = "update `user` set `nama`='$nama', `email`='$email',`deskripsi`='$deskripsi'
        ...
        if (!empty($_POST['soft_skill'])) {
            ...
            foreach ($_POST['soft_skill'] as $id_master_soft_skill) {
                $sql_is = "INSERT INTO `soft_skill`(`id_master_soft_skill`, `id_user`)
        ...
        if (!empty($_POST['hard_skill'])) {
            ...
            foreach ($_POST['hard_skill'] as $id_master_hard_skill) {
                $sql_ih = "INSERT INTO `hard_skill`(`id_master_hard_skill`, `id_user`) 
