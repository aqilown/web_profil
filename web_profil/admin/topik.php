...
if ((isset($_GET['aksi'])) && (isset($_GET['data']))) {
  if ($_GET['aksi'] == 'hapus') {
    ...
    $sql_dh = "delete from `master_topik` where `id_master_topik` = '$id_master_topik'";
          ...
          <div class="card-body">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                $sql_jum = "SELECT `id_master_topik`,`topik` FROM `master_topik`";
                if(isset($_GET["katakunci"])){
                  $katakunci_topik = $_GET["katakunci"];
                  $sql_jum .= "where `topik` LIKE '%$katakunci_topik%'";
                }
                $sql_jum .="ORDER BY `topik`";
                ...
                ?>
                  <tr>
                    ...
                    <td align="center">
                      <a href="edittopik.php?data=<?php echo $id_master_topik; ?>"
                        class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                      <a href="javascript:if(confirm('Anda yakin ingin menghapus data
                        <?php echo $topik; ?>?'))window.location.href ='topik.php?aksi=hapus&data=<?php echo $id_master_topik; ?>&notif=hapusberhasil'"
              ...
              if ($jum_halaman == 0) {
                ...
                if (isset($_GET["katakunci"])) {
                  ...
                  if ($halaman != $jum_halaman) {
                    echo "<li class='page-item'><a class='page-link'href='topik.php?katakunci=$katakunci_topik&halaman=$setelah'>»</a></li>";
                    echo "<li class='page-item'><a class='page-link'href='topik.php?katakunci=$katakunci_topik&halaman=$jum_halaman'>Last</a></li>";
                  }
                } else {
                  if ($halaman != 1) {
                  ...
                  if ($halaman != $jum_halaman) {
                    ...
                    echo "<li class='page-item'><a class='page-link'href='topik.php?halaman=$jum_halaman'>Last</a></li>";
                  }
                }
              } ?>
            </ul>
